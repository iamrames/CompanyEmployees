...
internal sealed class CompanyService : ICompanyService
{
    ...
    public async Task<(IEnumerable<CompanyDto> companies, string ids)> CreateCompanyCollectionAsync(IEnumerable<CompanyForCreationDto> companyCollections)
    {
        if (companyCollections is null)
